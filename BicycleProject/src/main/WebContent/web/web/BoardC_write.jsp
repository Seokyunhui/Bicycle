...
<body>
    ...
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="select-box select-script">
                    <select id="selectbox" title="선택 구분" name="constituency">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="select-box select-script">
                    <select id="selectbox" title="지역 선택" name="constituency">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="제목" id="title" name="title-header">
                </div>
            </div>
            <div class="col-lg-1"></div>
            <div class="col-lg-1"></div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="form-group">
                    <textarea class="form-control" rows="20" placeholder="글 양식입니다.
                    &#13;&#10;이름:&#13;&#10;&#13;&#10;가격:&#13;&#10;&#13;&#10;번호:&#13;&#10;&#13;&#10;지역:&#13;&#10;&#13;&#10;내용:&#13;&#10;&#13;&#10;*양식에 맞추어 작성 해주세요*." id="summernote" name="content"></textarea>
                </div>
